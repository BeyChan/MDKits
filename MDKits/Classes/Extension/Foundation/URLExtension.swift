...
extension URL {
    ...
    /// CMYKit: Dictionary of the URL's query parameters
...
extension URL {
    ...
    /// CMYKit: URL with appending query parameters.
    ///
    ...
    /// CMYKit: Append query parameters to URL.
    ///
    ...
    /// CMYKit: Get value of a query key.
    ///
    ...
    /// CMYKit: Returns a new URL by removing all the path components.
    ///
    ...
    /// CMYKit: Remove all the path components from the URL.
    ///
    ...
    /// CMYKit: Generates new URL that does not have scheme.
    ///
